...
SWIFT_CLASS("_TtC11Weather_App8SecondVC")
@interface SecondVC : UIViewController <UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified WeatherTemperature;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified cityLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified ConditionImage;
- (void)viewDidLoad;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified cityLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified CurrentDegree;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified WeatherImage;
- (IBAction)LocationButton:(UIButton * _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(Weather_App)) <CLLocationManagerDelegate>
